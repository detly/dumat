...
def linebezierintersect(coordinates):
    #parametric line
    
    ((lx1,ly1),(lx2,ly2)),((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)) = coordinates
...
def beziertatslope(coordinates,delta):
    ((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)) = coordinates
    (dy,dx) = delta
    ax,ay,bx,by,cx,cy,x0,y0=bezierparameterize(((bx0,by0),(bx1,by1),(bx2,by2),(bx3,by3)))
...
def tpoint(coordinates1,coordinates2,t):
    (x1,y1) = coordinates1
    (x2,y2) = coordinates2
...
'''
def pointdistance(coordinates1,coordinates2):
    (x1,y1) = coordinates1
    (x2,y2) = coordinates2
